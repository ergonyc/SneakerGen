...
img_run_id = "0821-2318"   # last full image training runs
img_run_id = "0824-2245"   # last full image training runs cf_img_size =  256
img_run_id = "0828-2326"   # last full image training runs cf_img_size =  224
img_run_id = "0831-1253"   # last full image training runs cf_img_size =  192
...
def trainModel(num_epochs, save_interval=10, validate_interval=5):
    ...
    for epoch in range(1, num_epochs):
        ...
        if ut.checkStopSignal(dir_path=cf.TXT_RUN_DIR):
            print(f"Stop signal recieved...epochn={epoch}({lg.total_epochs})")
            break
