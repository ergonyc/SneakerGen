...
cf_cat_prefixes = ut.cf_cat_prefixes = ['goat','sns'] #['04379243','03001627','03636649','03325088','03046257','02876657','03593526','03642806','02818832','03797390','02880940'] # ['04379243','03001627','03636649','03642806']  #,'03636649','03325088','03046257','02876657','03593526','03642806']
...
cf_limits=[cf_vox_size, cf_vox_size]
#ut.readMeta()
...
#%% Make model and print info
model = cv.CVAE_EF(cf_latent_dim, cf_vox_size, cf_learning_rate, training=True)
...
def trainModel(epochs, display_interval=-1, save_interval=10, test_interval=10) :
    ...
    for epoch in range(1, epochs + 1):
        ...
        if ((display_interval > 0) & (epoch % display_interval == 0)) :
            ut.showReconstruct(model, test_samples, title=lg.total_epochs, index=sample_index, show_original=True, save_fig=lg.remote, limits=cf_limits)
...
#%% 
n_epochs = 100
trainModel(n_epochs, display_interval=2, save_interval=4, test_interval=2)



#%% 

model.saveMyModel(lg.root_dir, 666)
#%% 
